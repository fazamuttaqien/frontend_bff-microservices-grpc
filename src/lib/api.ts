...
export type RequestOptions = Omit<RequestInit, 'body' | 'headers'> & { body?: unknown; headers?: HeadersInit; token?: string }
...
export async function request<T>(path: string, options: RequestOptions = {}): Promise<T> {
  ...
  try {
    ...
    throw new ApiError(0, 'Unable to reach the BFF server')
  }
